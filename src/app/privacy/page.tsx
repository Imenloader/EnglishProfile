      ...
      <section style={{ padding: '12rem 0 8rem' }}>
        <div className="container">
          <div className="glass-dark" style={{ 
            ...
            <h1 style={{ fontSize: '3.5rem', marginTop: '1.5rem', marginBottom: '4rem', fontFamily: 'var(--font-serif)' }}>{t('privacyPolicy')}</h1>
            ...
            <div className="policy-content" style={{ opacity: 0.8, lineHeight: 1.8, fontSize: '1.1rem' }}>
              ...
              <h3 style={{ color: 'white', marginTop: '3rem', marginBottom: '1.5rem', fontSize: '1.5rem' }}>1. {t('qualityAssurance')}</h3>
              <p>
                {t('qa1')}
              </p>

              <h3 style={{ color: 'white', marginTop: '3rem', marginBottom: '1.5rem', fontSize: '1.5rem' }}>2. {t('trackingTitle')}</h3>
              <p>
                {t('trackingDesc')}
              </p>
