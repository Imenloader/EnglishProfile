...
export default function AdminDashboard() {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      // O(1) Lookup Optimization: Group answers by lead_id
      ...
      const matrixData = filteredLeads.map((l: any) => {
        ...
        // O(1) Lookup Optimization: Map answers by question_text
        const answersByQuestionText = new Map();
        studentAnswers.forEach((a: any) => answersByQuestionText.set(a.question_text, a));
        ...
        uniqueQuestions.forEach((q: any) => {
          const ans = answersByQuestionText.get(q);
      ...
      // 3. DETAILED ANSWERS
      // O(1) Lookup Optimization: Precompute Set of filtered lead IDs
