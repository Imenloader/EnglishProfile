...
export default function AdminDashboard() {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      // Optimization: Pre-compute Hash Map and Set for O(1) lookups during complex data aggregations
      ...
      const matrixData = filteredLeads.map((l: any) => {
        // Optimization: O(1) retrieval instead of O(N) array filter
        ...
        uniqueQuestions.forEach((q: any) => {
          // Optimization: O(1) lookup instead of O(M) array find
      ...
      // 3. DETAILED ANSWERS
      // Optimization: O(1) set check instead of O(N) array some() iteration
