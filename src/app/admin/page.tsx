...
export default function AdminDashboard() {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      // ⚡ Bolt Optimization: Pre-compute answers mapping to avoid O(N^2) complexity in nested loops
      ...
      // ⚡ Bolt Optimization: Pre-compute valid lead IDs for O(1) membership checks
