...
export default function AdminDashboard() {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      // Performance Optimization: Pre-compute Hash Maps and Sets to avoid O(N^2) nested array iterations
      ...
      const matrixData = filteredLeads.map((l: any) => {
        ...
        studentAnswers.forEach((a: any) => studentAnswersMap.set(a.question_text, a));
