...
export default function AdminDashboard() {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      // Bolt: Pre-compute answers by lead_id to prevent O(N^2) complexity during export mapping
      ...
      // 3. DETAILED ANSWERS
      // Bolt: Use Set for O(1) lookups instead of .some() in .filter() for detailed answers
